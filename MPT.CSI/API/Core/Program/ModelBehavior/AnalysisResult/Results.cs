...
namespace MPT.CSI.API.Core.Program.ModelBehavior.AnalysisResult
{
    ...
    public class Results : CSiApiBase
    {
            ...
            ref double[] SAngleAvg)
        {
            ...
            stressesTop = new Stress[numberOfResults - 1];
            stressesBottom = new Stress[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void BaseReaction(ref int numberOfResults,
            ref string[] loadCases,
            ref string[] stepTypes,
            ref double[] stepNumbers,
            ...
            ref Coordinate3DCartesian baseReactionCoordinate)
        {
            ...
            _callCode = _sapModel.Results.BaseReact(ref numberOfResults,
                ref loadCases,
                ref stepTypes,
                ref stepNumbers,
            ...
            reactions = new Reactions[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
                reactions[i].Fx = Fx[i];
                reactions[i].Fy = Fy[i];
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void BaseReactionWithCentroid(ref int numberOfResults,
            ref string[] loadCases,
            ref string[] stepTypes,
            ref double[] stepNumbers,
            ref Reactions[] reactions,
            ...
            ref Coordinate3DCartesian[] centroidFzCoordinates)
        {
            ...
            _callCode = _sapModel.Results.BaseReactWithCentroid(ref numberOfResults,
                ref loadCases,
                ref stepTypes,
                ref stepNumbers,
                ref Fx, ref Fy, ref Fz, 
            ...
            reactions = new Reactions[numberOfResults - 1];
            centroidFxCoordinates = new Coordinate3DCartesian[numberOfResults - 1];
            centroidFyCoordinates = new Coordinate3DCartesian[numberOfResults - 1];
            centroidFzCoordinates = new Coordinate3DCartesian[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
                reactions[i].Fx = Fx[i];
                reactions[i].Fy = Fy[i];
            ...
            ref Deformations[] accelerations)
        {
            ...
            accelerations = new Deformations[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
            ...
            ref Deformations[] displacements)
        {
            ...
            displacements = new Deformations[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
            ...
            ref Deformations[] velocities)
        {
            ...
            velocities = new Deformations[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
            ...
            ref Deformations[] deformations)
        {
            ...
            deformations = new Deformations[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void ModalLoadParticipationRatios(ref int numberOfResults,
            ref string[] loadCases,
        ...
        {
            _callCode = _sapModel.Results.ModalLoadParticipationRatios(ref numberOfResults,
                ref loadCases,
                ref itemTypes,
                ref items,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void ModalParticipatingMassRatios(ref int numberOfResults,
            ref string[] loadCases,
            ref string[] stepTypes,
            ref double[] stepNumbers,
            ref double[] periods,
            ...
            ref Mass[] massRatioSums)
        {
            ...
            _callCode = _sapModel.Results.ModalParticipatingMassRatios(ref numberOfResults,
                ref loadCases,
                ref stepTypes,
                ref stepNumbers,
                ref periods,
            ...
            massRatios = new Mass[numberOfResults - 1];
            massRatioSums = new Mass[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void ModalParticipationFactors(ref int numberOfResults,
            ref string[] loadCases,
            ref string[] stepTypes,
            ref double[] stepNumbers,
            ref double[] periods,
            ...
            ref double[] modalStiffnesses)
        {
            ...
            _callCode = _sapModel.Results.ModalParticipationFactors(ref numberOfResults,
                ref loadCases,
                ref stepTypes,
                ref stepNumbers,
                ref periods,
            ...
            participationFactors = new Mass[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void ModalPeriod(ref int numberOfResults,
            ref string[] loadCases,
            ref string[] stepTypes,
            ref double[] stepNumbers,
            ref double[] periods,
        ...
        {
            _callCode = _sapModel.Results.ModalPeriod(ref numberOfResults, 
                ref loadCases, 
                ref stepTypes, 
                ref stepNumbers, 
                ref periods, 
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void SectionCutAnalysis(ref int numberOfResults,
            ref string[] sectionCuts,
            ref string[] loadCases,
            ref string[] stepTypes,
            ref double[] stepNumbers,
            ref Loads[] analysisForces)
        {
            ...
            _callCode = _sapModel.Results.SectionCutAnalysis(ref numberOfResults,
                ref sectionCuts,
                ref loadCases,
                ref stepTypes,
                ref stepNumbers,
            ...
            analysisForces = new Loads[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
        ...
        /// </summary>
        /// <param name="numberOfResults">The total number of results returned by the program.</param>
        /// <param name="sectionCuts"></param>
        /// <param name="loadCases">The name of the analysis case or load combination associated with each result.</param>
        /// <param name="stepTypes">The step type, if any, for each result.</param>
        /// <param name="stepNumbers">The step number, if any, for each result.</param>
        /// <param name="designForces">The internal forces for each result.</param>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void SectionCutDesign(ref int numberOfResults,
            ref string[] sectionCuts,
            ref string[] loadCases,
            ref string[] stepTypes,
            ref double[] stepNumbers,
            ref Forces[] designForces)
        {
            ...
            _callCode = _sapModel.Results.SectionCutDesign(ref numberOfResults,
                ref sectionCuts,
                ref loadCases,
                ref stepTypes,
                ref stepNumbers,
            ...
            designForces = new Forces[numberOfResults - 1];
            for (int i = 0; i < numberOfResults; i++)
            {
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void BucklingFactor(ref int numberOfResults,
            ref string[] loadCases,
            ref string[] stepTypes,
            ref double[] stepNumbers,
            ref double[] bucklingFactors)
        {
            _callCode = _sapModel.Results.BucklingFactor(ref numberOfResults, ref loadCases, ref stepTypes, ref stepNumbers, ref bucklingFactors);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
