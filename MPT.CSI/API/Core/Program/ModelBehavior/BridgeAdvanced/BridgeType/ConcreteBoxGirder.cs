...
namespace MPT.CSI.API.Core.Program.ModelBehavior.BridgeAdvanced.BridgeType
{
    ...
    public class ConcreteBoxGirder : CSiApiBase
    {
            ...
            ref double[] xCoordinatesWebRight)
        {
            ...
            _callCode = _sapModel.BridgeAdvancedSuper.BASConcBox.GetSuperCutWebCoordsAtY(name, cutIndex, yCoordinate, ref numberOfWebs, ref webIsCut, ref xCoordinatesWebLeft, ref xCoordinatesWebRight);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
