...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel
{
    ...
    public class AISC_LRFD_93 : CSiApiBase
    {
...
#region Methods: Public
        ...
        {
            _callCode = _sapModel.DesignSteel.AISC_LRFD93.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignSteel.AISC_LRFD93.SetOverwrite(name, (int)item, value, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
