...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel
{
    ...
    public class Chinese_2002 : CSiApiBase
    {
...
#region Methods: Public
        ...
        {
            _callCode = _sapModel.DesignSteel.Chinese_2002.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignSteel.Chinese_2002.SetOverwrite(name, (int)item, value, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
