...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel
{
    ...
    public class AS_4100_1998 : CSiApiBase
    {
...
#region Methods: Public
        ...
        {
            _callCode = _sapModel.DesignSteel.Australian_AS4100_98.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignSteel.Australian_AS4100_98.SetOverwrite(name, (int)item, value, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
