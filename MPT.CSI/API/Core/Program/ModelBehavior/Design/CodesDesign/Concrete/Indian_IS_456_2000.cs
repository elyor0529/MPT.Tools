...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete
{
    ...
    public class Indian_IS_456_2000 : CSiApiBase
    {
...
#region Methods: Public
        ...
        {
            _callCode = _sapModel.DesignConcrete.Indian_IS_456_2000.SetOverwrite(name, (int)item, value, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
