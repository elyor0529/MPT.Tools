...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete
{
    ...
    public class AASHTO_LRFD_2012 : CSiApiBase
    {
    ...
    #region Methods: Public
        ...
        {
            _callCode = _sapModel.DesignConcrete.AASHTO_Concrete_12.SetOverwrite(name, (int)item, value, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
