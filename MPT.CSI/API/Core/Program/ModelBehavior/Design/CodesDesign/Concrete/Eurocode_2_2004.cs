...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete
{
    ...
    public class Eurocode_2_2004 : CSiApiBase
    {
        ...
        {
            _callCode = _sapModel.DesignConcrete.Eurocode_2_2004.SetOverwrite(name, (int)item, value, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
