...
#region Methods: Interface
        ...
        public void GetGroup(ref string[] nameGroups)
        {
            ...
            _callCode = _sapModel.DesignAluminum.GetGroup(ref numberOfGroups, ref nameGroups);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        {
            _callCode = _sapModel.DesignAluminum.GetComboDeflection(ref numberOfItems, ref nameLoadCombinations);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void GetComboStrength(ref int numberOfItems, 
            ref string[] nameLoadCombinations)
        {
            _callCode = _sapModel.DesignAluminum.GetComboStrength(ref numberOfItems, ref nameLoadCombinations);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
