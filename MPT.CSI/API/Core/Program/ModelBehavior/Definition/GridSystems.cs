...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition
{
    ...
    /// </summary>
    public class GridSystems : CSiApiBase,
        IChangeableName, ICountable, IDeletable, IListableNames, IObservableTransformationMatrix
    {
        ...
        {
            _callCode = _sapModel.GridSys.GetNameList(ref numberOfNames, ref coordinateSystemNames);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        /// <exception cref="CSiException"></exception>
        public void GetNameTypeList(ref int numberOfNames,
            ref string[] gridSystemNames,
            ref string[] gridSystemTypes
            )
        {
            _callCode = _sapModel.GridSys.GetNameTypeList(ref numberOfNames, ref gridSystemNames, ref gridSystemTypes);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        #endregion
    }
