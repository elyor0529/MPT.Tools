namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadCase
{
    ...
    public interface IStaticNonlinear:
        ISetLoadCase, IInitialLoadCase, IModalCase, IMassSource, 
        IGeometricNonlinearity, INonlinearSolutionControlParameters, IHingeUnloading, ITargetForceParameters
    {
        ...
        /// [L] when <paramref name="degreeOfFreedom"/> = <see cref="eDegreeOfFreedom.U1"/>, <see cref="eDegreeOfFreedom.U2"/> or <see cref="eDegreeOfFreedom.U3"/> and [rad] when <paramref name="degreeOfFreedom"/> = <see cref="eDegreeOfFreedom.R1"/>, <see cref="eDegreeOfFreedom.R5"/> or <see cref="eDegreeOfFreedom.R6"/>.
