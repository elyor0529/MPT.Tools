...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadCase
{
    ...
    public class TimeHistoryDirectNonlinear : CSiApiBase, ITimeHistoryDirectNonlinear
    {
            ...
            ref double[] angles)
        {
            ...
            _callCode = _sapModel.LoadCases.DirHistNonlinear.GetLoads(name, ref numberOfLoads, ref csiLoadTypes, ref loadNames, ref functions, ref scaleFactor, ref timeFactor, ref arrivalTime, ref coordinateSystems, ref angles);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
            ...
            double[] angles)
        {
            ...
            _callCode = _sapModel.LoadCases.DirHistNonlinear.SetLoads(name, numberOfLoads, ref csiLoadTypes, ref loadNames, ref functions, ref scaleFactor, ref timeFactor, ref arrivalTime, ref coordinateSystems, ref angles);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
