...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadCase
{
    ...
    public class PowerSpectralDensity : CSiApiBase, ISteadyState
    {
            ...
            ref double[] angles)
        {
            ...
            _callCode = _sapModel.LoadCases.PSD.GetLoads(name, ref numberOfLoads, ref csiLoadTypes, ref loadNames, ref functions, ref scaleFactor, ref phaseAngle, ref coordinateSystems, ref angles);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
            ...
            ref double[] stiffnessProportionalDampingCoefficients)
        {
            ...
            _callCode = _sapModel.LoadCases.PSD.GetDampInterpolated(name, ref csiFrequencyUnit, ref numberOfFrequencies, ref frequencies, ref massProportionalDampingCoefficients, ref stiffnessProportionalDampingCoefficients);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        ...
        {
            _callCode = _sapModel.LoadCases.PSD.SetDampInterpolated(name, (int)frequencyUnit, numberOfFrequencies, ref frequencies, ref massProportionalDampingCoefficients, ref stiffnessProportionalDampingCoefficients);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
