...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadCase
{
    ...
    public class SteadyState : CSiApiBase, ISteadyState
    {
            ...
            ref double[] angles)
        {
            ...
            _callCode = _sapModel.LoadCases.SteadyState.GetLoads(name,ref numberOfLoads, ref csiLoadTypes, ref loadNames, ref functions, ref scaleFactor, ref phaseAngle, ref coordinateSystems, ref angles);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
            ...
            double[] angles)
        {
            ...
            _callCode = _sapModel.LoadCases.SteadyState.SetLoads(name, numberOfLoads, ref csiLoadTypes, ref loadNames, ref functions, ref scaleFactor, ref phaseAngle, ref coordinateSystems, ref angles);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void SetFrequencyData(string name,
            ...
            string modalCase,
            int numberSignedFractionalDeviations,
            double[] signedFractionalDeviations,
            int numberSpecifiedFrequencies,
            double[] specifiedFrequencies)
        {
            _callCode = _sapModel.LoadCases.SteadyState.SetFreqData(name, frequencyFirst, frequencyLast, numberOfFrequencies,
                ...
                numberSignedFractionalDeviations, ref signedFractionalDeviations, numberSpecifiedFrequencies, ref specifiedFrequencies);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
            ...
            ref double[] stiffnessProportionalDampingCoefficients)
        {
            ...
            _callCode = _sapModel.LoadCases.SteadyState.GetDampInterpolated(name, ref csiFrequencyUnit, ref numberOfFrequencies, ref frequencies, ref massProportionalDampingCoefficients, ref stiffnessProportionalDampingCoefficients);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        ...
        {
            _callCode = _sapModel.LoadCases.SteadyState.SetDampInterpolated(name, (int)frequencyUnit, numberOfFrequencies, ref frequencies, ref massProportionalDampingCoefficients, ref stiffnessProportionalDampingCoefficients);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
