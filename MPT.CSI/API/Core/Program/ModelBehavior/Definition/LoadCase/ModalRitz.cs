...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadCase
{
    ...
    public class ModalRitz : CSiApiBase, IModalRitz
    {
            ...
            ref double[] targetDynamicParticipationRatio)
        {
            ...
            _callCode = _sapModel.LoadCases.ModalRitz.GetLoads(name, ref numberOfLoads, ref csiLoadTypes, ref loadNames, ref maxNumberGenerationCycles, ref targetDynamicParticipationRatio);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
            ...
            double[] targetDynamicParticipationRatio)
        {
            ...
            _callCode = _sapModel.LoadCases.ModalRitz.SetLoads(name, numberOfLoads, ref csiLoadTypes, ref loadNames, ref maxNumberGenerationCycles, ref targetDynamicParticipationRatio);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        #endregion
#endif
