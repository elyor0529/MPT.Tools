...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadCase
{
    ...
    public class TimeHistoryModalNonlinear : CSiApiBase, ITimeHistoryModalNonlinear
    {
            ...
            ref double[] angles)
        {
            ...
            _callCode = _sapModel.LoadCases.ModHistNonlinear.GetLoads(name, ref numberOfLoads, ref csiLoadTypes, ref loadNames, ref functions, ref scaleFactor, ref timeFactor, ref arrivalTime, ref coordinateSystems, ref angles);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
            ...
            double[] angles)
        {
            ...
            _callCode = _sapModel.LoadCases.ModHistNonlinear.SetLoads(name, numberOfLoads, ref csiLoadTypes, ref loadNames, ref functions, ref scaleFactor, ref timeFactor, ref arrivalTime, ref coordinateSystems, ref angles);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
            ...
            ref double[] damping)
        {
            ...
            _callCode = _sapModel.LoadCases.ModHistNonlinear.GetDampInterpolated(name, ref csiDampingType, ref numberOfItems, ref periodsOrFrequencies, ref damping);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        ...
        public void SetDampingInterpolated(string name,
            ...
            double[] damping)
        {
            _callCode = _sapModel.LoadCases.ModHistNonlinear.SetDampInterpolated(name, (int)dampingType, numberOfItems, ref periodsOrFrequencies, ref damping);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void GetDampingOverrides(string name,
            ...
            ref double[] damping)
        {
            _callCode = _sapModel.LoadCases.ModHistNonlinear.GetDampOverrides(name, ref numberOfItems, ref modes, ref damping);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void SetDampingOverrides(string name,
            ...
            double[] damping)
        {
            _callCode = _sapModel.LoadCases.ModHistNonlinear.SetDampOverrides(name, numberOfItems, ref modes, ref damping);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
