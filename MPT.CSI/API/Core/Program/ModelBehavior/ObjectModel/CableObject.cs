...
namespace MPT.CSI.API.Core.Program.ModelBehavior.ObjectModel
{
    ...
    public class CableObject : CSiApiBase, ICableObject
    {
        ...
        {
            _callCode = _sapModel.CableObj.SetGroupAssign(name, groupName, remove, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void SetMass(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.SetMass(name, value, replace, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void DeleteMass(string name,
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.DeleteMass(name, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
            ...
            eItemType itemType = eItemType.Object)
        {
            ...
            _callCode = _sapModel.CableObj.SetInsertionPoint(name, isStiffnessTransformed, ref offset1, ref offset2, coordinateSystem, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void SetMaterialTemperature(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.SetMatTemp(name, temperature, patternName, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void GetLoadGravity(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.GetLoadGravity(name, ref numberItems, ref names, ref loadPatterns, ref coordinateSystems, ref xLoadMultiplier, ref yLoadMultiplier, ref zLoadMultiplier, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void SetLoadGravity(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.SetLoadGravity(name, loadPattern, xLoadMultiplier, yLoadMultiplier, zLoadMultiplier, replace, coordinateSystem, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void DeleteLoadGravity(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.DeleteLoadGravity(name, loadPattern, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void GetLoadDeformation(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.GetLoadDeformation(name, ref numberItems, ref names, ref loadPatterns, ref U1, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void SetLoadDeformation(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.SetLoadDeformation(name, loadPattern, ref U1, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void DeleteLoadDeformation(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.DeleteLoadDeformation(name, loadPattern, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void GetLoadTargetForce(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.GetLoadTargetForce(name, ref numberItems, ref names, ref loadPatterns, ref forceValues, ref relativeForcesLocations, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void SetLoadTargetForce(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.SetLoadTargetForce(name, loadPattern, ref forceValue, ref relativeForceLocation, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void DeleteLoadTargetForce(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.DeleteLoadTargetForce(name, loadPattern, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void GetLoadStrain(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.GetLoadStrain(name, ref numberItems, ref names, ref loadPatterns, ref strainLoadValues, ref jointPatternNames, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void SetLoadStrain(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.SetLoadStrain(name, loadPattern, strainLoadValue, replace, jointPatternName, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void DeleteLoadStrain(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.DeleteLoadStrain(name, loadPattern, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void GetLoadTemperature(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.GetLoadTemperature(name, ref numberItems, ref names, ref loadPatterns, ref temperatureLoadValues, ref jointPatternNames, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void SetLoadTemperature(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.SetLoadTemperature(name, loadPattern, temperatureLoadValue, jointPatternName, replace, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void DeleteLoadTemperature(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.DeleteLoadTemperature(name, loadPattern, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
            ...
            eItemType itemType = eItemType.Object)
        {
            ...
            _callCode = _sapModel.CableObj.GetLoadDistributed(name, ref numberItems, ref names, ref loadPatterns, ref csiForceTypes, ref coordinateSystems, ref csiLoadDirections, ref loadValues, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        ...
        public void SetLoadDistributed(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.SetLoadDistributed(name, loadPattern, (int)forceType, (int)loadDirection, loadValue, coordinateSystem, replace, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        ...
        public void DeleteLoadDistributed(string name,
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.CableObj.DeleteLoadDistributed(name, loadPattern, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
            ...
            eItemType itemType = eItemType.Object)
        {
            ...
            _callCode = _sapModel.CableObj.GetLoadDistributedWithGUID(name, ref numberItems, ref names, ref loadPatterns, ref csiForceTypes, ref coordinateSystems, ref csiLoadDirections, ref loadValues, ref GUIDs, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
