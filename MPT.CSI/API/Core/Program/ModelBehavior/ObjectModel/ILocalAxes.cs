...
namespace MPT.CSI.API.Core.Program.ModelBehavior.ObjectModel
{
    ...
    public interface ILocalAxes
    {
        ...
        /// <param name="angleOffset">This is the angle that the local 2 and 3 axes are rotated about the positive local 1 axis, from the default orientation. 
        ...
        void SetLocalAxes(string name,
            ref double angleOffset,
            ref eItemType itemType);
    }
}
