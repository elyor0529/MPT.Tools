namespace MPT.CSI.API.Core.Program.ModelBehavior.ObjectModel
{
    ...
    public interface IAutoMesh
    {
        ...
        void GetAutoMesh(string name,
            ...
            ref int maxSizeOfObjectsAlongPoint12,
            ref int maxSizeOfObjectsAlongPoint13,
            ref int maxSizeOfObjectsAlongPoint15,
        ...
        void SetAutoMesh(string name,
            ...
            int maxSizeOfObjectsAlongPoint12 = 0,
            int maxSizeOfObjectsAlongPoint13 = 0,
            int maxSizeOfObjectsAlongPoint15 = 0,
