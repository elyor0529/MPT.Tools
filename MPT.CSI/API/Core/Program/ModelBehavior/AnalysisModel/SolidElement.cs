...
namespace MPT.CSI.API.Core.Program.ModelBehavior.AnalysisModel
{
    ...
    public class SolidElement : CSiApiBase, ISolidElement
    {
        ...
        {
            _callCode = _sapModel.SolidElm.GetLoadTemperature(name, ref numberItems, ref names, ref loadPatterns, ref temperatureLoadValues, ref jointPatternNames, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        ...
        public void GetLoadPorePressure(string name,
            ...
            eItemTypeElement itemType = eItemTypeElement.Element)
        {
            _callCode = _sapModel.SolidElm.GetLoadPorePressure(name, ref numberItems, ref names, ref loadPatterns, ref porePressureLoadValues, ref jointPatternNames, CSiEnumConverter.ToCSi(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
