...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.Property
{
    ...
    public class LinkProperties : CSiApiBase, ILinkProperties
    {
            ...
            ref double eta)
        {
            ...
            _callCode = _sapModel.PropLink.GetMultiLinearPoints(name, csiDegreeOfFreedom, ref _numberOfItems, ref forces, ref displacements, ref csiLinkHysteresisType, ref alpha1, ref alpha2, ref beta1, ref beta2, ref eta);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
            ...
            double eta = 0)
        {
            ...
            _callCode = _sapModel.PropLink.SetMultiLinearPoints(name, (int)degreeOfFreedom, forces.Length, ref forces, ref displacements, (int)linkHysteresisType, alpha1, alpha2, beta1, beta2, eta);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
