...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.Property
{
    ...
    public class AreaSection : CSiApiBase, IAreaSection
    {
            ...
            ref eMaterialComponentBehaviorType[] S12Types)
        {
            ...
            _callCode = _sapModel.PropArea.GetShellLayer_1(name, ref _numberOfItems, ref layerNames, ref distanceOffsets, ref thicknesses, ref csiLayerTypes, ref numberOfIntegrationPoints, ref materialProperties, ref materialAngles, ref csiS11Types, ref csiS22Types, ref csiS12Types);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
