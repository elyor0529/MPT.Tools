...
namespace MPT.CSI.API.Core.Program.ModelBehavior.ObjectModel
{
    ...
    public class FrameObject : CSiApiBase, IFrameObject
    {
            ...
            ref string[] elementNames)
        {
            ...
            GetElement(name, ref elementNames, ref relativeDistanceI, ref relativeDistanceJ);
        }
        ...
        {
            _callCode = _sapModel.FrameObj.GetElm(name, ref _numberOfItems, ref elementNames, ref relativeDistanceI, ref relativeDistanceJ);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(); }
        }
        #endregion
        ...
        /// or
        /// Array " + offset2 + " should have 3 elements, but has " + offset2.Length + " elements.</exception>
